...
def create_app():
    ...
    # CORS: somente as origens configuradas
    ...
    def calcular_presumido():
        ...
        difal = get_difal_pa(preco_liquido, data['ano'], data['uf_saida'], data['uf_entrada']) if data['tipo']=='venda' else 0
...
# para gunicorn: "api:app"
app = create_app()

if __name__ == "__main__":
    # útil só local – Render usa gunicorn e injeta $PORT
